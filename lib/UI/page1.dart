...
TextEditingController controller =TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: TextField(style: TextStyle(color: Colors.white),controller: controller,onSubmitted: (value){
          BlocProvider.of<InstaBloc>(context).add(FetchInstaEvent(id:controller.text));
          BlocProvider.of<PostBloc>(context).add(FetchpostEvent(post: controller.text));
          BlocProvider.of<HighlightBloc>(context).add(FetchHighlightEvent(Highlights:controller.text));
    ...
    return Column(
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  CircleAvatar(radius: 50.r,backgroundImage: NetworkImage(instagram.data!.profilePicUrlHd.toString()),),
                  SizedBox(
                    width: 25.w,
                  ),
                  Column(
            ...
            Padding(
              ...
              child: Text(instagram.data!.fullName.toString(),
                style: GoogleFonts.inter(
                  textStyle: TextStyle(
                    color: Colors.white,
                    fontSize: 20.sp,
  ...
  builder: (context, state) {
    if( state is HighlightBlocLoading){
      ...
      highlightid= BlocProvider.of<HighlightBloc>(context).highlightModel;
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundColor: Colors.black,
                            child: CircleAvatar(
                              radius: 34.r,backgroundImage: NetworkImage(highlightid.data!.items![position].coverMedia!.croppedImageVersion!.url.toString()),
                            ),
                          ),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 5),
                          child: SizedBox(width: 30.w,height: 10.h,
                            child: Text(
                             highlightid.data!.items![position].title.toString(),
                              style: GoogleFonts.inter(
                                textStyle: TextStyle(
                    ...
                    child: TabBarView(children: [
                      BlocBuilder<PostBloc, PostState>(
                        builder: (context, state) {
                          ...
                          posts= BlocProvider.of<PostBloc>(context).postModels;
                              ...
                              return Container(
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: NetworkImage(posts.data!.items![index].imageVersions!.items![0].url.toString()),
                                    fit: BoxFit.cover,
                                  ),
